...
def descriptive_analysis():
	...
	# with col1:
		...
		st.write('Product Package - ' + selected_product_category + ' - Kurtosis of normal distribution: {}'.format(
			stats.kurtosis(stats_df['Total Quantity'])))
		st.write('Product Package - ' + selected_product_category + ' - Skewness of normal distribution: {}'.format(
